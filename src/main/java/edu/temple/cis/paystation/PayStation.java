...
public interface PayStation {
    ...
    /**
     * Calculate parking time based on the total amount of money inserted.
     *
     * @return the parking time in minutes
     */
    default int calculateTime(String town, int coinValue) {
        if(town.equals("Alphatown")){
            Alphatown calculateTime = new Alphatown();
            return calculateTime.calculateTime(coinValue);
        }
        if(town.equals("Betatown")){
            Betatown calculateTime = new Betatown();
            return calculateTime.calculateTime(coinValue);
        }
        if(town.equals("Deltatown")){
            Deltatown calculateTime = new Deltatown();
            return calculateTime.calculateTime(coinValue);
        }
        if(town.equals("Gammatown")){
            Gammatown calculateTime = new Gammatown();
            return calculateTime.calculateTime(coinValue);
        }
        if(town.equals("Omegatown")){
            Omegatown calculateTime = new Omegatown();
            return calculateTime.calculateTime(coinValue);
    ...
    */ 
    ...
    /**
     * Return the town that the paystation is currently set to.
     *
     * @return the town that the paystation is currently set to.
     */
    ...
    /**
     * Return the town and amount of money collected by the machine
     *
     * @return the town and amount of money collected by the machine in a string
     */
